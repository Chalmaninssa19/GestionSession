...
public class FrontServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</body>");
            out.println("</html>");
            out.println("this is me : "+request.getSession().getId());
           /*
            try {
                ...
                SessionObject so = new SessionObject(request.getSession().getId(), dateTimeNow);
                Session session = new Session(so, conn);
                session.setAttribute("prenom", "chalman");
        ...
        RequestDispatcher dispat = request.getRequestDispatcher("pages/login.jsp");
